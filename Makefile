...
SRC_DIR = src
SRC = $(SRC_DIR)/checkinput.c $(SRC_DIR)/color.c $(SRC_DIR)/color_endian.c $(SRC_DIR)/fdf.c $(SRC_DIR)/handlers.c $(SRC_DIR)/init.c $(SRC_DIR)/lines.c $(SRC_DIR)/math_utils.c $(SRC_DIR)/parseinput.c $(SRC_DIR)/projection.c $(SRC_DIR)/render.c $(SRC_DIR)/zoom.c
OBJ = $(SRC:.c=.o)
